...
<template>
    <AdminLayout>
        ...
        <transition 
                ...
                <div v-if="showCompra" class="fixed inset-0 z-[50] flex items-center justify-center mt-15">
                    ...
                    <div class="relative bg-white dark:bg-gray-900 rounded-xl shadow-2xl  w-full max-w-5xl h-[550px] overflow-y-auto overflow-x-hidden flex flex-col items-center ml-56">
                        ...
                        <h3 class="text-gray-300 text-md font-semibold my-5 font-Outfit">Nuevo Medicamento</h3>
                        <form method="post">
                            <div class=" grid grid-cols-3 xs:grid-cols-1 space-y-6 space-x-2 max-w-4xl w-full ">
                                <div> 
        ...
        <div class="grid grid-cols-1 gap-6">
            <div class=" font-Outfit text-2xl text-gray-200">Medicamentos</div>
        <ComponentCard title="Lista de Medicamentos">
